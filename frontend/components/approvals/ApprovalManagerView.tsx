...
import { CheckSquare, AlertTriangle, ShieldCheck, Trash2, ExternalLink, Search, RefreshCw } from 'lucide-react';
...
export const ApprovalManagerView: React.FC = () => {
  ...
  const approvalsLoading = useSentinelStore((state) => state.approvalsLoading);
  const approvalsError = useSentinelStore((state) => state.approvalsError);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-[#1E1E1E]">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-[#111111] border border-[#1E1E1E] hover:border-primary/40 text-accent hover:text-white transition-all disabled:opacity-50 shrink-0"
            title="Refresh from on-chain data"
          >
      ...
      {approvalsError && (
        <div className="p-3.5 rounded-xl bg-primary/10 border border-primary/30 text-xs text-primary flex items-center gap-2">
          ...
          <span>Couldn&apos;t load real approvals: {approvalsError}</span>
        </div>
      )}
                ...
                {approvalsLoading ? (
                  <tr>
                    <td colSpan={6} className="py-12 text-center text-accent text-sm">
                      ...
                      Checking on-chain allowances against the watchlist...
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td colSpan={6} className="py-12 text-center text-accent text-sm">
                      ...
                      No active allowances found against the watchlist. Your wallet looks clean!
                    </td>
                  </tr>
                ) : (
